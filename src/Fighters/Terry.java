...
public class Terry extends  Fighter{
    ...
    public Terry(Panel panel, int playerPosition) {
        ...
        super.idle = new int[][][]{
                {{7, 10, 71, 105, 0}, {17, 90, 33, 90}},
                {{97, 12, 70, 103, 0}, {17, 90, 33, 90}},
                {{193, 12, 70, 103, 0}, {17, 90, 33, 90}},
                {{288, 13, 70, 102, 0}, {17, 90, 33, 90}},
                {{379, 15, 70, 100, 0}, {17, 90, 33, 90}},
                {{470, 16, 70, 99, 0},  {17, 90, 33, 90}},
                {{566, 16, 70, 99, 0}, {17, 90, 33, 90}},
                {{656, 13, 70, 102, 0}, {17, 90, 33, 90}}
        };
        super.walkingForward = new int[][][]{
                {{8, 653, 63, 101, 0}, {23, 91, 37, 91}},
                {{94, 650, 61, 104, 0}, {20, 92, 38, 91}},
                {{171, 645, 54, 109, 0}, {22, 93, 36, 91}},
                {{240, 641, 51, 113, 3}, {22, 95, 36, 91}},
                {{309, 645, 50, 109, 0}, {23, 94, 37, 91}},
                {{381, 649, 56, 105, 0}, {23, 92, 37, 91}},
                {{452, 653, 63, 101, 0}, {23, 91, 37, 91}},
        };
        super.walkingBackward = new int[][][]{
                {{559, 651, 63, 103, 0}, {25, 91, 37, 90}},
                {{640, 648, 56, 106, 0}, {26, 94, 39, 94}},
                {{713, 644, 48, 110, 0}, {25, 98, 39, 98}},
                {{778, 640, 47, 114, 3}, {24, 101, 38, 101}},
                {{840, 643, 44, 111, 0}, {21, 99, 36, 99}},
                {{905, 648, 49, 106, 0}, {23, 92, 37, 92}},
                {{971, 651, 63, 103, 0}, {25, 91, 40, 91}},
        };
        super.crouch = new int[][][]{
                {{656, 13, 70, 102, 0}, {19, 62, 36, 62}},
                {{752, 36, 63, 79, 0},  {19, 62, 36, 62}},
                {{837, 42, 63, 73, 0},  {19, 62, 36, 62}},
                {{921, 42, 63, 73, 0},  {19, 62, 36, 62}}
        };
        super.jump = new int[][][]{
                {{7, 201, 63, 80, 0}, {20, 70, 35, 70}},
                {{90, 208, 63, 73, 0}, {22, 65, 37, 65}},
                {{174, 146, 44, 135, 12}, {21, 152, 38, 58}},
                {{174, 146, 44, 135, 50}, {21, 152, 38, 58}},
                {{174, 146, 44, 135, 70}, {21, 152, 38, 58}},
                {{236, 172, 43, 109, 91}, {21, 100, 33, 55}},
                {{297, 191, 55, 90, 101}, {22, 100, 35, 40}},
                {{366, 183, 49, 98, 91}, {22, 100, 38, 50}},
                {{436, 144, 62, 136, 70}, {24, 100, 36, 61}},
                {{511, 144, 60, 137, 50}, {24, 100, 36, 61}},
                {{511, 144, 60, 137, 5}, {24, 100, 36, 61}},
                {{588, 208, 64, 73, 0}, {22, 65, 37, 65}},
                {{672, 201, 63, 80, 0}, {20, 70, 35, 70}},
        };
        super.jumpForward = new int[][][]{
                {{7, 201, 63, 80, 0}, {20, 70, 35, 70}},
                {{90, 208, 63, 73, 0}, {22, 65, 37, 65}},
                {{168, 354, 55, 90, 50}, {23, 56, 48, 38}},
                {{240, 374, 55, 50, 91}, {23, 48, 45, 48}},
                {{309, 365, 50, 55, 98}, {23, 39, 52, 39}},
                {{374, 378, 62, 44, 100}, {21, 58, 40, 48}},
                {{451, 363, 44, 62, 97}, {23, 95, 37, 78}},
                {{508, 346, 49, 98, 70}, {24, 100, 36, 61}},
                {{511, 144, 60, 137, 50}, {24, 100, 36, 61}},
                {{511, 144, 60, 137, 5}, {24, 100, 36, 61}},
                {{588, 208, 64, 73, 0}, {22, 65, 37, 65}},
                {{672, 201, 63, 80, 0}, {20, 70, 35, 70}},
        ...
        super.jumpBackward = new int[][][]{
                ...
                {{90, 208, 63, 73, 0}, {22, 65, 37, 65}},
                {{168, 354, 55, 90, 50}, {23, 56, 48, 38}},
                {{374, 378, 62, 44, 91}, {21, 58, 40, 48}},
                {{309, 365, 50, 55, 98}, {23, 39, 52, 39}},
                {{240, 374, 55, 50, 100}, {23, 48, 45, 48}},
                {{451, 363, 44, 62, 97}, {23, 95, 37, 78}},
                {{508, 346, 49, 98, 70}, {24, 100, 36, 61}},
                {{511, 144, 60, 137, 50}, {24, 100, 36, 61}},
                {{511, 144, 60, 137, 5}, {24, 100, 36, 61}},
